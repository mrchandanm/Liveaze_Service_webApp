...
const AddCarpenterService = () => {
    ...
    e.preventDefault();
        ...
        try {   
            const res=await axios.post(`${process.env.REACT_APP_API}/api/v1/admin/add-services`,{minimumCharge,maximumCharge,serviceName,serviceType:"Carpenter",providedBy:adminid}
            );
...
export default AddCarpenterService
