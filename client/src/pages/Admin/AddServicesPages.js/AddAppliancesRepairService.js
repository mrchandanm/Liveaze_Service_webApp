...
const AddAppliancesRepairService = () => {
    ...
    e.preventDefault();
        ...
        try {   
            const res=await axios.post(`${process.env.REACT_APP_API}/api/v1/admin/add-services`,{minimumCharge,maximumCharge,serviceName,serviceType:"Appliances Repair",providedBy:adminid}
            );
...
export default AddAppliancesRepairService
